...
var subpages = ["button","button","button","button","button"]
var subpages_name = ["Home","Donate","Links","Manga","Winnyace"]
var subpages_icon = ["home","favorite","person","menu_book","question_mark"]
var subpages_dest = ["'/index.html'","'/donate.html'","'/info.html'","'/manga/main.html'","'/winnyace.html'"]
